...
def ask(prompt, default=None, color=colored.green):
  ...
  puts(MOVE_CURSOR_UP + ERASE_LINE + build_prompt(prompt, color(response)))

  return response


def questionnaire(questions, confirm_color=colored.green):
